...
def locks(client, message,redis):
  ...
  if text == c.Lfwd and  (rank is "sudo" or rank is "asudo" or rank is "sudos" or rank is "malk" or rank is "acreator"):
  ...
  if text == c.Ufwd and  (rank is "sudo" or rank is "asudo" or rank is "sudos" or rank is "malk" or rank is "acreator"):
    get = redis.sismember("{}Nbot:Lfwd".format(BOT_ID),chatID)
    if get :
