...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/"+uui9u)],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/mribot")],[InlineKeyboardButton("قناة البوتات 🤖", url="t.me/uui9u")]])
